...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline:
      "Automating clinical-trial eligibility criteria with retrieval-augmented generation over a 267K-trial oncology dataset.",
    description: [
      "A research project at USC's AI for Healthcare Lab that reduces the manual effort of writing inclusion and exclusion criteria for oncology trials. I built a retrieval pipeline over the 267K-trial EC-RAFT clinical-trials dataset, embedding and indexing the oncology corpus with SciNCL in ChromaDB via SLURM jobs on USC's CARC HPC cluster for top-k semantic search.",
